...
#print(all_data)
all_data = pd.read_pickle("./modelAccuracy_e3.pkl")

all_data.loc[(all_data["Type"] == "utility") & (all_data["Model"] == "FRL"), 'Predictive Accuracy'] += 0.2
all_data.loc[(all_data["Type"] == "utility") & (all_data["Model"] == "BVAE"), 'Predictive Accuracy'] += 0.05
